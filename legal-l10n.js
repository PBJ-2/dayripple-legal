(function () {
  ...
  var supportData = {
    ...
    nb: {
      ...
      payment: "Napauta sovelluksessa <b>Asetukset → Maksutilanne → Tarkista keskeneräiset ostot</b>. Samaa kaupan tapahtumaa ei voi käyttää useammassa kuin yhdessä tilassa.",
    ...
    hi: {
      ...
      payment: "ऐप में <b>सेटिंग्स → पेमेंट स्टेटस → अधूरी ख़रीद जाँचें</b> पर टैप करें। एक ही स्टोर ट्रांज़ैक्शन एक से ज़्यादा स्पेस पर लागू नहीं किया जा सकता।",
      deleteTitle: "अकाउंट डिलीट करना",
      delete: "आप अकाउंट सीधे <b>सेटिंग्स → अकाउंट → अकाउंट डिलीट करें</b> में डिलीट कर सकते हैं, या <a href=\"./delete-account.html\">अकाउंट डिलीट करने के अनुरोध वाला पेज</a> इस्तेमाल करें।",
      privacy: "प्राइवेसी पॉलिसी",
    },
    ar: {
      intro: "هذه صفحة دعم DayRipple — أسهل طريقة لمشاركة الأحداث والذكرى والمهام مع أقرب الناس إليك.",
      contact: "تواصل معنا",
      paymentTitle: "إذا لم تكتمل عملية الشراء",
      payment: "في التطبيق، انقر على <b>الإعدادات → حالة الدفع → التحقق من المشتريات غير المكتملة</b>. لا يمكن تطبيق معاملة المتجر الواحدة على أكثر من مساحة.",
      deleteTitle: "حذف الحساب",
      "delete": "يمكنك حذف حسابك مباشرة من <b>الإعدادات → الحساب → حذف الحساب</b>، أو استخدام <a href=\"./delete-account.html\">صفحة طلب حذف الحساب</a>.",
  ...
  var deleteData = {
    ...
    nb: {
      ...
      items: ["Innloggingskonto, e-postadresse, profil og kallenavn", "Medlemskap i rom og tokener for pushvarsler", "Informasjon om uferdige kjøp på enheten, planlagte varsler og status for analyseidentifikatoren", "Hendelser, merkedager／D-dager og oppgaver du har opprettet", "Rom som bare du brukte, og dataene deres"],
    ...
    hr: {
      heading: "Brisanje računa DayRipple i podataka", intro: "Ovako brišete podatke povezane s vašim računom DayRipple.",
    ...
    sl: {
      heading: "Izbris računa DayRipple in podatkov", intro: "Tako izbrišete podatke, povezane z vašim računom DayRipple.",
    ...
    hi: {
      ...
      instantTitle: "ऐप में तुरंत डिलीट करें", instant: "DayRipple में साइन इन करें, फिर <b>सेटिंग्स → अकाउंट → अकाउंट डिलीट करें</b> पर टैप करें। पुष्टि करते ही डिलीट होना शुरू हो जाता है।",
    ...
    ar: {
      heading: "حذف حساب DayRipple وبياناتك", intro: "إليك كيف تُحذف البيانات المرتبطة بحساب DayRipple الخاص بك.",
      instantTitle: "الحذف الفوري داخل التطبيق", instant: "سجّل الدخول إلى DayRipple ثم انقر على <b>الإعدادات → الحساب → حذف الحساب</b>. يبدأ الحذف فور التأكيد.",
      noAccessTitle: "إذا تعذّر وصولك إلى التطبيق", noAccess: "أرسل طلب الحذف عبر الزر أدناه من عنوان البريد الإلكتروني نفسه الذي سجّلت به. لا تُرسل كلمة المرور أو رقم بطاقة الدفع.", button: "طلب الحذف عبر البريد الإلكتروني", deletedTitle: "البيانات التي تُحذف",
      items: ["حساب تسجيل الدخول والبريد الإلكتروني والملف الشخصي والاسم المستعار", "عضويات المساحات ورموز الإشعارات", "حالة المشتريات غير المكتملة على الجهاز والإشعارات المجدولة ومعرّفات التحليلات", "ما أنشأته من أحداث وذكرى/عدّ تنازلي ومهام", "المساحات التي كنت وحدك تستخدمها وبياناتها"],
      retention: "المساحات المشتركة التي بقي فيها أعضاء آخرون تنتقل إليهم. سجلات الدفع التي يُلزم القانون بالاحتفاظ بها قد تُحفظ منفصلة للمدة المقررة؛ وقد يبقى حق الشراء للمساحة المشتركة بعد فك ارتباطه بالحساب المحذوف. الإحصاءات المجهولة المجمّعة دون أي ارتباط بالحساب لا يُعاد التعرف عليها كبيانات حساب بعينه. إذا أردت حذف تقارير أخطاء Sentry الحالية أيضًا، فاذكر ذلك في البريد.",
      timing: "تُعالج الطلبات الواردة بالبريد دون تأخير بعد التحقق من الهوية، وتكتمل عادة خلال 7 أيام.", privacy: "سياسة الخصوصية", support: "الدعم",
    },
};
  ...
  var privacyData = {
    ...
    ar: privacyRecord([
      "سياسة خصوصية DayRipple", "تاريخ السريان: 15 يوليو 2026", "تتعامل DayRipple («الخدمة») مع معلوماتك الشخصية بعناية وتلتزم بالقوانين السارية، ومنها قانون حماية المعلومات الشخصية في كوريا.", "حذف الحساب والبيانات", "يمكنك حذف حسابك فورًا من <b>الإعدادات → الحساب → حذف الحساب</b>. وإذا تعذّر استخدام التطبيق، فاستخدم <a href=\"./delete-account.html\">صفحة طلب الحذف</a>.",
      "1. المعلومات الشخصية التي نجمعها", ["الفئة","المعلومات","التوقيت"], [["الحساب","عنوان البريد الإلكتروني، بيانات تسجيل دخول مشفّرة، الاسم المستعار، معرّف المستخدم","عند التسجيل أو تسجيل الدخول الاجتماعي"],["إعدادات اختيارية","الموافقة على تحليلات تحسين المنتج أو رفضها","عندما تختار ذلك"],["استخدام الخدمة","الأحداث، الذكرى/العدّ التنازلي، المهام، أسماء المساحات والأعضاء","عندما تدخلها بنفسك"],["الجهاز والإشعارات","رمز الإشعارات، نظام التشغيل، اللغة، المنطقة الزمنية، الموافقات حسب النوع، آخر استخدام","عند تفعيل الإشعارات أو تشغيل التطبيق"],["الدفع","معرّفا المعاملة والمنتج، حالة الشراء/الاسترداد، معرّف عشوائي للربط","عند الشراء داخل التطبيق"],["إحصاءات مجهولة","أسماء الإجراءات الرئيسية المكتملة وفئات معمّمة، إصدار التطبيق، النظام، معرّف تثبيت مجهول","بعد موافقة صريحة"],["الأخطاء","إصدار التطبيق، النظام، نوع الخطأ وموضعه في الكود، معرّف مستخدم داخلي","عند حدوث خطأ أو انهيار"]],
      "يعالج المدفوعات متجر Apple App Store أو Google Play. لا تجمع الخدمة أرقام البطاقات أو الحسابات البنكية أو أي تفاصيل دفع أخرى ولا تحتفظ بها.", "لا تتضمن إحصاءات PostHog وتقارير Sentry البريد الإلكتروني أو الأسماء المستعارة أو أسماء المساحات أو نوع العلاقة أو رموز وروابط الدعوة أو عناوين وملاحظات الأحداث والذكرى والمهام أو معرّفات ورموز الدفع. لا نجمع معرّفات إعلانية أو الموقع أو جهات الاتصال أو الصور، ولا نتتبع نشاطك في تطبيقات ومواقع شركات أخرى، ولا نستخدم تسجيل الشاشة أو إعادة تشغيل الجلسات.",
      "2. أغراض الاستخدام", ["التحقق من الهوية وتسجيل الدخول","مشاركة الأحداث والذكرى والمهام بين الأعضاء المدعوين","إرسال التذكيرات وإشعارات النشاط","إشعارات العودة وفق اللغة والمنطقة الزمنية وحالة المساحة بعد إذن مستقل","التحقق من ممر مدى الحياة والمقاعد الإضافية وتعديل الوصول عند الاسترداد أو الإلغاء","تحسين الميزات عبر تحليلات مجهولة بموافقة صريحة فقط","معالجة الأخطاء ومنع الرسوم المزدوجة وإساءة الاستخدام"],
      "3. الاحتفاظ والحذف", ["عند حذف الحساب نحذف دون تأخير الحساب والملف الشخصي والعضويات ورموز الأجهزة وخيارات التحليلات والمحتوى الذي أنشأته.","تُحذف المساحات التي كنت وحدك تستخدمها بالكامل. أما المساحات المشتركة فتنتقل إلى الأعضاء الباقين، مع حذف المحتوى الخاص بك.","حمايةً لبقية الأعضاء قد يبقى حق الشراء للمساحة المشتركة، لكن دون أي ارتباط بالحساب المحذوف.","يُستخدم PostHog بشكل مجهول — لا معرّف حساب ولا ملف شخصي. عند تسجيل الخروج أو الحذف يُعاد ضبط المعرّف المجهول للجهاز ولا تُربط الإحصاءات السابقة من جديد.","تُحفظ تقارير Sentry للمدة اللازمة فقط ثم تُحذف. ويمكن طلب حذف التقارير الحالية.","سجلات الدفع التي يُلزم القانون بالاحتفاظ بها تُحفظ منفصلة للمدة المقررة ثم تُتلف."],
      "الاسترداد والاحتفاظ بالبيانات", ["عند استرداد ممر مدى الحياة أو إلغائه تتوقف الميزات المدفوعة وتعود الحدود المجانية.","لا تُحذف سجلات معاملات المقاعد الإضافية وبيانات المساحة فورًا. قد يُقيَّد وصول الأعضاء الزائدين عن السعة دون محو البيانات.","عند استعادة السعة بحق صحيح يستعيد الأعضاء الوصول حسب ترتيب انضمامهم. ويُعامل حذف الحساب على حدة."],
      "4. المشاركة مع أطراف ثالثة والمعالجة", "لا تبيع الخدمة المعلومات الشخصية ولا تستخدمها لتتبع الإعلانات. تعالج الشركات التالية البيانات بوصفها معالجات لتشغيل الخدمة.", ["المعالج","المهمة","مكان التخزين"], [["تشغيل قاعدة البيانات وخوادم المصادقة","منطقة سيول، كوريا (AWS)"],["إرسال الإشعارات التي أذنت بها","الولايات المتحدة"],["تسجيل الدخول الاجتماعي والتحقق من المشتريات والإيصالات","حسب سياسة كل شركة"],["إحصاءات مجهولة بموافقة صريحة","الولايات المتحدة ومناطق أخرى للخدمة"],["تقارير الأخطاء والانهيارات","الولايات المتحدة ومناطق أخرى للخدمة"]],
      "5. حقوقك", "تحليلات تحسين المنتج متوقفة افتراضيًا. قبل اختيارك لا نُشغّل PostHog ولا نرسل أي إحصاءات. يُحفظ اختيارك على الحساب والجهاز ويُحترم حتى بعد إعادة التثبيت أو تغيير الجهاز. يمكن إيقاف التحليلات في أي وقت؛ وبعدها لا يُرسل أي حدث PostHog جديد. يمكنك أيضًا تعديل ملفك الشخصي في الإعدادات وحذف حسابك؛ وإذا تعذّر الوصول إلى التطبيق فاستخدم <a href=\"./delete-account.html\">طلب الحذف عبر الويب</a>.", "6. مسؤول الخصوصية والتواصل", "المسؤول: Park Byungjun", "تواصل معنا", "صفحة دعم DayRipple", "7. التغييرات", "عند حدوث تغييرات سنخطرك داخل التطبيق أو على هذه الصفحة."
    ]),
};
